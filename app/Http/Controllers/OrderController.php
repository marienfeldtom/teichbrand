...
class OrderController extends Controller
{
    ...
    public function export()
    {
        ...
        $reviews = Order::all();
        $columns = array('ID', 'Vorname', 'Nachname', 'E-Mail', 'T-Shirt', 'Cap', 'Fischerhut', 'Feuerzeuge', 'Betrag', 'Adresse', 'Handynummer',);
        ...
        $callback = function() use ($reviews, $columns)
        {
            ...
            foreach($reviews as $review) {
                fputcsv($file, array($review->id, $review->first_name, $review->last_name, $review->email, $review->tshirt, $review->cap, $review->hat, $review->lighter, $review->getPrice(), "", ""));
            }
            fclose($file);
        };

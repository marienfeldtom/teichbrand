...
<body class="leading-normal tracking-normal text-white gradient bg-gray-100"
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="pl-4 flex items-center">
                <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                    ...
                    <img class="h-8 fill-current inline text-white" alt="self-Logo" src="teich.svg">
                    Teichbrand
                </a>
            </div>
    ...
    <div class="pt-24" style="height: auto">
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center ">
            ...
            <div class="w-full md:w-3/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50 pb-20" src="logo2021.png">
            </div>
    ...
    <div class="relative -mt-12 lg:-mt-24 ">
        <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(-2.000000, 44.000000)" fill="rgba(243,244,246,1)" fill-rule="nonzero">
                    <path
                ...
                <g transform="translate(-4.000000, 76.000000)" fill="rgba(243,244,246,1)" fill-rule="nonzero">
                    <path
    ...
    <section class="bg-gray-100 py-8">
        ...
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            ...
            <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Preise</h1>
            ...
            <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
                ...
                <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                    <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                        <div class="p-8 text-3xl font-bold text-center border-b-4">Kostenlos</div>
                        <ul class="w-full text-center text-sm">
                            <li class="border-b py-4">Im Leben bekommt</li>
                            <li class="border-b py-4">man nichts</li>
                            <li class="border-b py-4">geschenkt :-(</li>
                        </ul>
                    </div>
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                        <div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center">0€ <span
                                class="text-base">pro Person</span></div>
                        <div class="flex items-center justify-center">
                            <button onclick="fehler()"
                                class="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg">Zur
                                Bestellung</button>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <div class="w-full p-8 text-3xl font-bold text-center">Full Weekend Ticket</div>
                        <div class="h-1 w-full gradient my-0 py-0 rounded-t"></div>
                        <ul class="w-full text-center text-base font-bold">
                            <li class="border-b py-4">3 Tage Camping</li>
                            <li class="border-b py-4">Gute Musik</li>
                            <li class="border-b py-4">Gute Stimmung</li>
                            <li class="border-b py-4">Festivalfeeling PUR</li>
                        </ul>
                    </div>
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                        <div class="w-full pt-6 text-4xl font-bold text-center">30€ <span class="text-base">/ pro
                                Person</span></div>
                        <div class="flex items-center justify-center">
                            <button
                ...
                <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                    <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                        <div class="p-8 text-3xl font-bold text-center border-b-4">Tages Ticket</div>
                        <ul class="w-full text-center text-sm">
                            <li class="border-b py-4">Gute Musik</li>
                            <li class="border-b py-4">Gute Stimmung</li>
                            <li class="border-b py-4">Ein bisschen Festivalfeeling</li>
                        </ul>
                    </div>
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <svg class="wave-top" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g transform="translate(-1.000000, -14.000000)" fill-rule="nonzero">
                ...
                <g transform="translate(1.000000, 15.000000)" fill="rgba(243,244,246,1)">
                    <g
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        ...
        <button
            class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg"><a
                href="/orders/create">Zur Bestellung</a></button>
...
-->
    ...
    <script>
        ...
        Swal.fire({
            title: 'MAAAAAN!',
            text: 'Es gibt immernoch nix geschenkt',
            icon: 'error',

...
<body class="bg-gray-500 bg-no-repeat bg-center bg-cover"
    style="background-image: url('https://ellocamping.de/wp-content/uploads/2019/09/zelt.jpg')">
            ...
            <div class="max-w-sm rounded overflow-hidden bg-white shadow-lg p-5">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class="text-gray-700 text-base">
                        Moin {{$order->first_name}}! Um dein Ticket zu erhalten, überweise bitte folgenden Betrag auf
                        eins dieser Konten: <br>
                        ...
                        <ul class="list-disc">
                            ...
                            @endif
                            @if($order->lighter != "0")
                            <li>+{{ $order->lighter*2 }}€ {{ $order->lighter }} Ferzeug/e</li>
                            @endif
                ...
                <div class="px-6 py-4">
                    <span
                        class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#bock</span>
                    <span
                        class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#auf</span>
                    <span
                        class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">#feiern</span>
                </div>
            </div>
